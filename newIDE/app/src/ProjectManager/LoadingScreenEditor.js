      ...
      {({ i18n }) => (
        <ColumnStackLayout expand noMargin>
          ...
          <ColumnStackLayout noMargin>
            <ResponsiveLineStackLayout noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display PixelForge logo at startup (in exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={<Trans>PixelForge logo style</Trans>}
            ...
            {/* <ResponsiveLineStackLayout noMargin>
              <Column expand noMargin justifyContent="center">
                <Checkbox
                  label={
                    <Trans>
                      Display PixelForge watermark after the game is loaded (in
                      exported game)
                    </Trans>
                  }
              ...
              <Column expand noMargin justifyContent="center">
                <SelectField
                  fullWidth
                  floatingLabelText={
                    <Trans>PixelForge watermark placement</Trans>
                  }
            ...
            {/* {shouldDisplayGetSubscriptionCard && (
              <GetSubscriptionCard subscriptionDialogOpeningReason="Disable GDevelop splash at startup">
                <Text>
                  <Trans>
                    Get a silver or gold subscription to disable PixelForge
                    branding.
                  </Trans>
                </Text>
              </GetSubscriptionCard>
          ...
          <SubscriptionChecker
            ...
            title={<Trans>Disable PixelForge splash at startup</Trans>}
          />
        </ColumnStackLayout>
      )}
    </I18n>
