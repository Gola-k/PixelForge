      ...
      try {
        ...
        if (
          ...
          await showAlert({
            ...
            message: t`The monthly free asset pack perk was not part of your plan at the time you got your subscription to PixelForge. To enjoy this perk, please purchase a new subscription.`,
          });
        } else {
          console.error(
