        ...
        {extensionShortHeader.tier === 'community' && (
          <AlertMessage kind="warning">
            <Trans>
              ...
              by the PixelForge extension team. As such, we can't guarantee it
              meets all the quality standards of official extensions. It could
              also not be compatible with older PixelForge versions. In case of
        ...
        {!isCompatible && (
          <AlertMessage kind="error">
            <Trans>
              ...
              PixelForge to work. Update PixelForge to be able to use this
