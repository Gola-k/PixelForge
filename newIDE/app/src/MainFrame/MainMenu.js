...
export const buildMainMenuDeclarativeTemplate = ({
        ...
        ? [
            ...
            ...(!!electron
              ? [
                  { type: 'separator' },
                  {
                    label: i18n._(t`Exit PixelForge`),
                    accelerator: getElectronAccelerator(
  ...
  //   submenu: [
  //     {
  //       label: i18n._(t`PixelForge website`),
  //       // onClickOpenLink: 'http://gdevelop.io',
  //       onClickOpenLink: '',
  //     },
  //     { type: 'separator' },
  //     {
  //       label: i18n._(t`PixelForge games on ce.games`),
  ...
  //     { type: 'separator' },
  //     {
  //       label: i18n._(t`Buy PixelForge goodies and swag`),
  //       // onClickOpenLink: 'https://goodies.gdevelop.io',
  //       onClickOpenLink: '',
  //     },
  //     {
  //       label: i18n._(t`Contribute to PixelForge`),
  //       // onClickOpenLink: 'https://gdevelop.io/page/contribute',
  //       onClickOpenLink: '',
  //     },
  //     {
  //       label: i18n._(t`Create Extensions for PixelForge`),
  //       // onClickOpenLink:
  ...
  //     { type: 'separator' },
  //     {
  //       label: i18n._(t`Help to Translate PixelForge`),
  ...
  //           { type: 'separator' },
  //           {
  //             label: i18n._(t`About PixelForge`),
