      ...
      .then(loadingResults => {
        ...
        if (dangerousLoadingResults.length) {
          console.error(
            ...
            } JS extensions. 🔥 Please check these errors as they will CRASH PixelForge:`,
    ...
    async (
      ...
      const checkForAutosave = async (): Promise<FileMetadata> => {
        ...
        const answer = await showConfirmation({
          ...
          message: t`PixelForge automatically saved a newer version of this project on ${new Date(
          ...
          confirmButtonLabel: t`PixelForge auto-save`,
        });
      ...
      const checkForAutosaveAfterFailure = async (): Promise<?FileMetadata> => {
        ...
        const answer = await showConfirmation({
          ...
          message: t`The project file appears to be corrupted, but an autosave file exists (backup made automatically by PixelForge on ${new Date(
            autoSaveCreationDate
