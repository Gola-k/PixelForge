      ...
      try {
        ...
        if (
          ...
          showAlert({
            ...
            message: t`Ensure you don't have any typo in your username and that you have joined the PixelForge Discord server.`,
          });
          return;
        }
        showAlert({
              ...
              <Column noMargin>
                ...
                <Text>
                  {!isAuthenticatedUserProfile ? (
                    ...
                    !canUserBenefitFromDiscordRole ? (
                      <MarkdownText
                        translatableSource={t`No discord username defined. Add it and get a Gold, Pro or Education subscription to claim your role on the [PixelForge Discord]().`}
                      />
                    ) : (
                      <MarkdownText
                        translatableSource={t`No discord username defined. Add it to claim your role on the [PixelForge Discord]().`}
                      />
                    )
                  ) : (
                    <>
                      ...
                      {!canUserBenefitFromDiscordRole && (
                        <>
                          {' - '}
                          <MarkdownText
                            translatableSource={t`Get a Gold or Pro subscription to claim your role on the [PixelForge Discord]().`}
                          />
                        </>
                      )}
                    </>
