...
const EditProfileDialog = ({
  ...
  return (
    <I18n>
      {({ i18n }) => (
        <Dialog
          title={<Trans>Edit your PixelForge profile</Trans>}
          actions={actions}
            ...
            <ColumnStackLayout noMargin>
              ...
              <TextField
                ...
                helperMarkdownText={i18n._(
                  t`Add your Discord username to get access to a dedicated channel if you have a Gold or Pro subscription! Join the [PixelForge Discord]().`
              ...
              <TextField
                ...
                rows={3}
                rowsMax={5}
                translatableHintText={t`What are you using PixelForge for?`}
                onChange={(e, value) => {
              ...
              <Checkbox
                label={
                  <Trans>I want to receive the PixelForge Newsletter</Trans>
                }
